      ...
      <div class="mb-10 grid gap-y-16 sm:grid-cols-3 sm:gap-x-8 sm:gap-y-16">
        <div class="relative">
          ...
          <div class="space-y-4">
            ...
            >
              ...
              penting, termasuk jadwal, keuangan, dan catatan siswa.
            </BaseParagraph>
            <BaseParagraph
              size="sm"
              lead="normal"
        ...
        <div class="relative">
          <BaseHeading
            ...
            class="mb-3"
          >
            Pemantauan Akademis yang Akurat dan Komprehensif
          </BaseHeading>
          <div class="space-y-4">
            <BaseParagraph
              size="sm"
        ...
        <div class="relative">
          ...
          <div class="space-y-4">
            ...
            <BaseParagraph
              ...
              class="text-muted-500 dark:text-muted-400"
            >
              Kami berkomitmen untuk menjaga tingkat keamanan tertinggi dengan
              melakukan pembaruan keamanan berkala. Ini mencakup pemantauan
              proaktif terhadap potensi risiko keamanan dan penerapan perbaikan
              segera untuk melindungi integritas sistem.
            </BaseParagraph>
            <BaseParagraph
              size="sm"
              lead="normal"
