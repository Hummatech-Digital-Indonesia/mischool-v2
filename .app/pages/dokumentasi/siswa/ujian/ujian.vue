...
definePageMeta({
  title: 'Ujian',
  description: 'Fitur Ujian dan Ulangan Siswa',
  layout: 'sidebar',
})

const toc: Toc[] = [
  { id: 'tutorial', level: 1, label: 'Tutorial' },
  { id: 'fitur-ujian', level: 2, label: 'Ujian' },
  { id: 'fitur-ulangan', level: 2, label: 'Ulangan' },
]

const tutorials = [
  {
    id: 1,
    title: 'Tutorial Fitur Ujian',
    slug: 'fitur-ujian',
    url: 'https://youtu.be/0DfhURDO6fw?si=2GlV6ENW9Y298uJf',
    cover: '/img/thumbnail/siswa/ujian.png',
  },
  {
    id: 2,
    title: 'Tutorial Fitur Ulangan',
    slug: 'fitur-ulangan',
    url: 'https://youtu.be/UOPSY6gd1PI?si=jICrnqzEYrUKngun',
    cover: '/img/thumbnail/siswa/ulangan.png',
  },
]
</script>
          ...
          <div class="mt-10 grow sm:mt-0">
            <div class="text-center sm:text-left">
              <BaseHeading tag="h1" class="text-white opacity-90">
                <span>Fitur Ujian</span>
              </BaseHeading>
              <BaseParagraph size="sm" class="text-white opacity-80">
                <span>
                  Fitur Ujian dapat digunakan siswa untuk mengerjakan ujian atau ulangan yang sudah disiapkan sekolah atau guru.
                </span>
              </BaseParagraph>
            </div>
          </div>
