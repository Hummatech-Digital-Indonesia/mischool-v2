...
definePageMeta({
  title: 'Pegawai',
  description: `Fitur Halaman Pegawai di Mischool memudahkan sekolah untuk mengelola data guru dan staff. Dengan menyediakan akses cepat untuk menambah dan melihat informasi penting seperti email, nama, dan detail lainnya yang tercantum di website Mischool. Setiap pegawai akan secara otomatis memiliki akun yang terhubung dengan email mereka, memungkinkan akses langsung ke platform Mischool. Solusi praktis untuk manajemen data pegawai yang efisien.`,
  layout: 'sidebar',
})

const toc: Toc[] = [
  { id: 'tutorial', level: 1, label: 'Tutorial' },
  { id: 'pegawai', level: 2, label: 'Pegawai' },
]

const tutorials = [
  {
    id: 1,
    title: 'Tutorial Halaman Pegawai',
    slug: 'pegawai',
    url: 'https://youtu.be/sh5L7an0-no?si=DgFkZZMtayR7Bumh',
    cover: '/img/thumbnail/sekolah/pegawai.png',
  },
]
</script>
