...
definePageMeta({
  title: 'Kehadiran',
  description:  `halaman kehadiran terdapat fitur pencarian untuk mencari nama
...
const toc: Toc[] = [
  ...
  { id: 'kehadiran', level: 2, label: 'Kehadiran' },
]

const tutorials = [
  {
    id: 1,
    title: 'Tutorial Halaman Kehadiran',
    slug: 'kehadiran',
    url: 'https://youtu.be/wksVdemYdSI?si=F2uH3SxxXiHpTlXk&t=123',
    cover: '/img/thumbnail/sekolah/kehadiran.png',
  },
]
</script>
