...
definePageMeta({
  title: 'Paket Anda',
  description: `pada fitur ini kita bisa melihat daftar paket yang sudah kita
                  beli. akan tertera juga deskripsi paket anda secara jelas.
                  mulai dari awal di beli, berakhrinya paket yang di beli, dan
                  perpanjang fitur.`,
  layout: 'sidebar',
})
const toc: Toc[] = [
  { id: 'tutorial', level: 1, label: 'Tutorial' },
  { id: 'paket', level: 2, label: 'Paket Anda' },
]

const tutorials = [
  {
    id: 1,
    title: 'Tutorial Halaman Paket Anda',
    slug: 'Paket',
    url: 'https://youtu.be/dEaEQRP7n4k?si=bLZZ2vk20V-etK5-',
    cover: '/img/thumbnail/sekolah/paket-anda.png',
  },
]
</script>
          ...
          <div class="mt-10 grow sm:mt-0">
            <div class="text-center sm:text-left">
              <BaseHeading tag="h1" class="text-white opacity-90">
                <span>Halaman Paket Fitur</span>
              </BaseHeading>
              <BaseParagraph size="sm" class="text-white opacity-80">
                <span>
                  pada fitur ini kita bisa melihat daftar paket yang sudah kita
                  beli. akan tertera juga deskripsi paket anda secara jelas.
                  mulai dari awal di beli, berakhrinya paket yang di beli, dan
                  perpanjang fitur.
                </span>
