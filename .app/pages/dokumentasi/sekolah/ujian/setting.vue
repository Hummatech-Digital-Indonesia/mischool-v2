...
definePageMeta({
  title: 'Ujian',
  description: `Di halaman menu ujian, tersedia data ujian yang dapat dicari
                  berdasarkan semester dan tingkatannya. Kita juga bisa
                  menambahkan ujian , mengedit, menghapus ujian, serta melihat detail
                  seperti tahun ajaran, jumlah soal, semester, kelas, tanggal
                  mulai dan berakhir, dan waktu pengerjaan.`,
  layout: 'sidebar',
})

const toc: Toc[] = [
  { id: 'tutorial', level: 1, label: 'Tutorial' },
  { id: 'ujian', level: 2, label: 'Ujian' },
]

const tutorials = [
  {
    id: 1,
    title: 'Tutorial Halaman Ujian',
    slug: 'ujian',
    url: 'https://youtu.be/gI3rR-0OL-E?si=CvVuuiyG-dCwMLnj',
    cover: '/img/thumbnail/sekolah/ujian.png',
  },
]
</script>
          ...
          <div class="mt-10 grow sm:mt-0">
            <div class="text-center sm:text-left">
              ...
              <BaseParagraph size="sm" class="text-white opacity-80">
                <span>
                  Di halaman menu ujian, tersedia data ujian yang dapat dicari
                  berdasarkan semester dan tingkatannya. Kita juga bisa
                  menambahkan ujian, mengedit, menghapus ujian, serta melihat detail
                  seperti tahun ajaran, jumlah soal, semester, kelas, tanggal
                  mulai dan berakhir, dan waktu pengerjaan.
