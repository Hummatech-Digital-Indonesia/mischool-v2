...
definePageMeta({
  title: 'Ujian Selesai',
  description: `Di halaman menu ujian selesai, kita dapat melihat data ujian
...
const toc: Toc[] = [
  ...
  { id: 'ujian-selesai', level: 2, label: 'Ujian Selesai' },
]

const tutorials = [
  {
    id: 1,
    title: 'Tutorial Halaman Ujian Selesai',
    slug: 'ujian-selesai',
    url: 'https://youtu.be/gI3rR-0OL-E?si=CvVuuiyG-dCwMLnj',
    cover: '/img/thumbnail/sekolah/ujian-selesai.png',
  },
]
</script>
