          ...
          <div class="mt-10 grow sm:mt-0">
            <div class="text-center sm:text-left">
              ...
              <BaseParagraph size="sm" class="text-white opacity-80">
                <span>
                  Di halaman bank soal user dapat memilih kelas dan juga
                  meilahat soal dari beberapa mata pelajaran. Dengan menekan
                  tombol lihat soal. Di halaman lihat soal user dapat melihat
                  beberpa soal yang berhubungan dengan mata pelajaran yang di
                  pilih.
                </span>
              </BaseParagraph>
            </div>
      ...
      <BaseCard class="col-span-2 mt-16 p-4 grid grid-cols-2 gap-2" id="fitur">
        <div class="col-span-2 md:col-span-1">
          <BaseHeading tag="h1" id="apa-itu-Mischool" class="opacity-90">
            <span>Fitur Halaman Bank Soal</span>
          </BaseHeading>
          <BaseParagraph size="sm" class="opacity-80 mt-3">
            <span>
              Penjelasan lebih detail mengenai penggunaan fitur bank soal dapat
