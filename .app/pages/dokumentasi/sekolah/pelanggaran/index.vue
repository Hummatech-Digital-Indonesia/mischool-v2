...
definePageMeta({
  title: 'Pelanggaran',
  description: `  Di halaman pelanggaran, kita dapat melihat jenis pelanggaran
...
const toc: Toc[] = [
  ...
  { id: 'pelanggaran', level: 2, label: 'Pelanggaran' },
]

const tutorials = [
  {
    id: 1,
    title: 'Tutorial Halaman Pelanggaran',
    slug: 'pelanggaran',
    url: 'https://youtu.be/KINSJL-T59Q?si=TkN2gIAYm6c79UCK',
    cover: '/img/thumbnail/sekolah/pelanggaran.png',
  },
]
</script>
