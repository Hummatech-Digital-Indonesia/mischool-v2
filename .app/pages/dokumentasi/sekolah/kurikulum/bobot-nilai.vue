          ...
          <div class="mt-10 grow sm:mt-0">
            <div class="text-center sm:text-left">
              <BaseHeading tag="h1" class="text-white opacity-90">
                <span>Halaman Bobot Nilai</span>
              </BaseHeading>
              <BaseParagraph size="sm" class="text-white opacity-80">
                <span>
                  fitur bobot nilai. di bobot nilai dapat melihat nilai nilai
                  dari berbagai macam mata pelajaran dan juga bisa mengedit
                  nilai. Setelah itu terdapat opsi untuk memilih tahun ajaran
                  dan memilih semester.
                </span>
              </BaseParagraph>
            </div>
          </div>
      ...
      <BaseCard class="col-span-2 mt-16 p-4 grid grid-cols-2 gap-2" id="fitur">
        <div class="col-span-2 md:col-span-1">
          <BaseHeading tag="h1" id="apa-itu-AcsSchool" class="opacity-90">
            <span>Fitur Halaman Bobot Nilai</span>
          </BaseHeading>
          <BaseParagraph size="sm" class="opacity-80 mt-3">
            <span>
              Penjelasan lebih detail mengenai penggunaan fitur halaman bobot
              nilai dapat dilihat pada video tutorial berikut
            </span>
          </BaseParagraph>
        </div>
        <TutorialVideo
