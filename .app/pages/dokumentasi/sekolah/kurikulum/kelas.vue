...
definePageMeta({
  title: 'Kelas',
  description: ` Di fitur kelas ini, kita bisa menambahkan kelas dan memilih
...
const toc: Toc[] = [
  ...
  { id: 'kelas', level: 2, label: 'Kelas' },
]

const tutorials = [
  {
    id: 1,
    title: 'Tutorial Halaman Kelas',
    slug: 'kelas',
    url: 'https://youtu.be/SCV9EuwKYV8?si=uU9iVYIF1wHx_Lu2',
    cover: '/img/thumbnail/sekolah/kelas.png',
  },
]
</script>
