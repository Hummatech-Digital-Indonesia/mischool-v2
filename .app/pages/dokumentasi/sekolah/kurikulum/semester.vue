...
definePageMeta({
  title: 'Semester',
  description: ` Dalam fitur Semester, pengguna bisa memilih antara semester
                  ganjil atau genap, serta melihat tanggal perubahan semester.`,
  layout: 'sidebar',
})

const toc: Toc[] = [
  { id: 'tutorial', level: 1, label: 'Tutorial' },
  { id: 'semester', level: 2, label: 'Semester' },
]

const tutorials = [
  {
    id: 1,
    title: 'Tutorial Halaman Semester',
    slug: 'semester',
    url: 'https://youtu.be/tVxpNxu_04M?si=3mQEgawjq6J7gPv4',
    cover: '/img/thumbnail/sekolah/semester.png',
  },
]
</script>
          ...
          <div class="mt-10 grow sm:mt-0">
            <div class="text-center sm:text-left">
              <BaseHeading tag="h1" class="text-white opacity-90">
                <span>Halaman Semester</span>
              </BaseHeading>
              <BaseParagraph size="sm" class="text-white opacity-80">
                <span>
                  Dalam fitur Semester, pengguna bisa memilih antara semester
                  ganjil atau genap, serta melihat tanggal perubahan semester.
                </span>
              </BaseParagraph>
            </div>
