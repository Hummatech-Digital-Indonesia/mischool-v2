...
definePageMeta({
  title: 'Kelas',
  description: `Di fitur tingkatan kelas, kita dapat menambahkan, mengedit,
...
const toc: Toc[] = [
  ...
  { id: 'tingkatan-kelas', level: 2, label: 'Tingkatan Kelas' },
]

const tutorials = [
  {
    id: 1,
    title: 'Tutorial Halaman Tingkatan Kelas',
    slug: 'tingkatan-kelas',
    url: 'https://youtu.be/ZietxUtXI2s?si=CQxGbhzcadyughlY',
    cover: '/img/thumbnail/sekolah/tingkatan-kelas.png',
  },
]
</script>
          ...
          <div class="mt-10 grow sm:mt-0">
            <div class="text-center sm:text-left">
              <BaseHeading tag="h1" class="text-white opacity-90">
                <span>Halaman Tingkatan Kelas</span>
              </BaseHeading>
