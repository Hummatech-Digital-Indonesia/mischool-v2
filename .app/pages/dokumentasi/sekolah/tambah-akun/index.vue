...
definePageMeta({
  title: 'Tambah Akun',
  description: `Dalam fitur Tambah Akun, admin sekolah dapat menambahkan akun
                  untuk pengguna lain. Saat menambahkan akun, admin diminta
                  untuk memasukkan biodata dan peran pengguna. Selain itu, admin
                  juga bisa mengedit dan menghapus data pengguna.`,
  layout: 'sidebar',
})
const toc: Toc[] = [
  { id: 'tutorial', level: 1, label: 'Tutorial' },
  { id: 'paket', level: 2, label: 'Tambah Akun' },
]

const tutorials = [
  {
    id: 1,
    title: 'Tutorial Halaman Tambah Akun',
    slug: 'history',
    url: 'https://youtu.be/qGO3ZtGiqj8?si=k1lDnb-oZwjJr_wS',
    cover: '/img/thumbnail/sekolah/tambah-akun.png',
  },
]
</script>
          ...
          <div class="mt-10 grow sm:mt-0">
            <div class="text-center sm:text-left">
              ...
              <BaseParagraph size="sm" class="text-white opacity-80">
                <span>
                  Dalam fitur Tambah Akun, admin sekolah dapat menambahkan akun
                  untuk pengguna lain. Saat menambahkan akun, admin diminta
                  untuk memasukkan biodata dan peran pengguna. Selain itu, admin
                  juga bisa mengedit dan menghapus data pengguna.
                </span>
