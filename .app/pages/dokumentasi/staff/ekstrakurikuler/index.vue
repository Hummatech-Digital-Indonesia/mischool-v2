...
definePageMeta({
  ...
  description: `Fitur Ekstrakurikuler Mischool memungkinkan guru/staff untuk
                  memberi penilain ekstrakurikuler pada siswa anggota ekstrakuriler yang mereka bimbing,
                  penilaian ini juga akan bisa tampil di rapor siswa.`,
  layout: 'sidebar',
})
const toc: Toc[] = [
  { id: 'tutorial', level: 1, label: 'Tutorial' },
  { id: 'fitur-ekstrakurikuler', level: 2, label: 'Ekstrakurikuler' },
]
const tutorials = [
  {
    id: 1,
    title: 'Tutorial Fitur Ekstrakurikuler Akun Guru',
    slug: 'tutorial-guru',
    url: 'https://tairo.cssninja.io/dashboards/soccer',
    cover: '/img/thumbnail/staff/ekstrakurikuler.png',
  },
]
</script>
          ...
          <div class="mt-10 grow sm:mt-0">
            <div class="text-center sm:text-left">
              <BaseHeading tag="h1" class="text-white opacity-90">
                <span>Halaman Ekstrakurikuler</span>
              </BaseHeading>
              <BaseParagraph size="sm" class="text-white opacity-80">
                <span>
                  Fitur Ekstrakurikuler Mischool memungkinkan guru/staff untuk
                  memberi penilain ekstrakurikuler pada siswa anggota ekstrakuriler yang mereka bimbing,
                  penilaian ini juga akan bisa tampil di rapor siswa.
                </span>
              </BaseParagraph>
