...
definePageMeta({
  title: 'Koreksi Ujian',
  description: `Fitur Koreksi Mischool memungkinkan guru untuk menilai jawaban essay siswa dari kelas yang dia ajar,
                  untuk soal pilihan ganda sendiri sudah dikoreksi oleh sistem.`,
  layout: 'sidebar',
})
...
const featuredVideos = [
  {
    id: 1,
    title: 'Cara Mengoreksi Ujian',
    slug: 'cara-memilih-menu',
    url: 'https://youtu.be/L_Im80hWxfw?si=GUWSMdYmy530CoMt',
    cover: '/img/thumbnail/guru/mengoreksi-ujian.png',
  },
]
</script>
          ...
          <div class="mt-10 grow sm:mt-0">
            <div class="text-center sm:text-left">
              ...
              <BaseParagraph size="sm" class="text-white opacity-80">
                <span>
                  Fitur Koreksi Mischool memungkinkan guru untuk menilai jawaban essay siswa dari kelas yang dia ajar,
                  untuk soal pilihan ganda sendiri sudah dikoreksi oleh sistem.
                </span>
              </BaseParagraph>
            </div>
