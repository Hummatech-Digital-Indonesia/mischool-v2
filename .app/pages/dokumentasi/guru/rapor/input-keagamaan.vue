...
const featuredVideos = [
  {
    id: 1,
    title: 'Halaman Fitur Input Keagamaan',
    slug: '',
          ...
          <div class="mt-10 grow sm:mt-0">
            <div class="text-center sm:text-left">
              <BaseHeading tag="h1" class="text-white opacity-90">
                <span>Halaman Input Keagamaan</span>
              </BaseHeading>
              <BaseParagraph size="sm" class="text-white opacity-80">
                <span>
                  Fitur Input Keagamaan Mischool memungkinkan pengguna untuk membuat
                  input keagamaan secara cepat dan disesuaikan dengan mudah di dalam
